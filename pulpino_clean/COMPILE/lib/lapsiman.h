...
/**
 * @file
 * @brief Register mapping for LaPSIMAN peripherals.
 *
 * Contains event register mappings for the KC705 LaPSIMAN SOC Simple as
...
#define LAPSIMAN_BASE_ADDR             0x10000000

/** SOC PERIPHERALS */
#define SOC_PERIPHERALS_BASE_ADDR     ( LAPSIMAN_BASE_ADDR + 0xA100000 )
...
///* pointer to mem of apb lapsiman unit - PointerSocCtrl */
